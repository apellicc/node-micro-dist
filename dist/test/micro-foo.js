...
const MICRO_FOO = path_1.join(__dirname, 'fixtures/micro-foo/');
ava_1.default('Basic usage, create http server', (t) => __awaiter(this, void 0, void 0, function* () {
    stdMock.use();
    const { app, server } = yield src_1.default({
        path: MICRO_FOO
    });
    // Check /foo route added on foo/foo.init.ts
    let res = yield rp({ uri: 'http://localhost:5000/foo', resolveWithFullResponse: true, json: true });
    t.is(res.statusCode, 200);
    t.is(res.body.foo, 'bar');
    // Check / route
    res = yield rp({ uri: 'http://localhost:5000/', resolveWithFullResponse: true });
    t.is(res.statusCode, 200);
    t.is(res.body, '@neo9/n9-node-micro');
    // Check /ping route
    res = yield rp({ uri: 'http://localhost:5000/ping', resolveWithFullResponse: true });
    t.is(res.statusCode, 200);
    t.is(res.body, 'pong');
    // Check /404 route
    res = yield t.throws(rp({ uri: 'http://localhost:5000/404', resolveWithFullResponse: true, json: true }));
...
ava_1.default('Check /routes', (t) => __awaiter(this, void 0, void 0, function* () {
    stdMock.use();
    const { app, server } = yield src_1.default({
        path: MICRO_FOO,
        http: { port: 5575 }
    ...
    // Check /foo route added on foo/foo.init.ts
    const res = yield rp({ uri: 'http://localhost:5575/routes', resolveWithFullResponse: true, json: true });
    t.is(res.statusCode, 200);
...
ava_1.default('Call routes (versionning)', (t) => __awaiter(this, void 0, void 0, function* () {
    stdMock.use();
    const { app, server } = yield src_1.default({
        path: MICRO_FOO,
        http: { port: 5559 }
...
ava_1.default('Call routes (bad versions)', (t) => __awaiter(this, void 0, void 0, function* () {
    stdMock.use();
    const { app, server } = yield src_1.default({
        path: MICRO_FOO,
        http: { port: 5557 }
...
ava_1.default('Call routes with error in development (error key)', (t) => __awaiter(this, void 0, void 0, function* () {
    stdMock.use();
    const { app, server } = yield src_1.default({
        path: MICRO_FOO,
        http: { port: 5587 }
...
ava_1.default('Call routes with error in production (no leak)', (t) => __awaiter(this, void 0, void 0, function* () {
...
//# sourceMappingURL=micro-foo.js.map